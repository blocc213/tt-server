...
// The server host must stay free of the desktop/mobile app shell. `tauri` is the
// load-bearing entry: on Linux it pulls non-optional GTK/webkit system libraries,
// which a headless server has no reason to require.
const SERVER_HOST_FORBIDDEN_PACKAGES = new Set([
    'tauri',
    'tauri-build',
    'tauri-plugin-dialog',
    'tauri-plugin-fs',
...
const SERVER_HOST_FORBIDDEN_SOURCE_PATTERNS = [
    ['tauri', /\btauri::/],
    ['app host path', /\bcrate::app::/],
    ['tauri host crate', /\btauritavern_lib::/],
];
...
const CRATES = [
    ...
    crateConfig('tauritavern-server', SERVER_HOST_FORBIDDEN_PACKAGES, SERVER_HOST_FORBIDDEN_SOURCE_PATTERNS),
];
