...
use crate::file_system::{delete_file, read_json_file, write_json_file};
use crate::preset_file_naming::{PresetFilePaths, load_named_preset_files};
...
pub struct FilePresetRepository {
    /// Packaged default-content reader
        ...
        for item in content_items {
                ...
                && item_type == *preset_type
            {
                ...
                if item_name == name {
                    ...
                    let data: Value =
                        self.read_resource_json(&format!("default/content/{}", item.filename))?;
